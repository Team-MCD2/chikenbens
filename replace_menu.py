...
menu = [
    ...
    "items": [
      {
        ...
        "allergens": ["Gluten", "Oeufs", "Lait", "Sésame"]
      },
      {
        "name": "Tacos Tikka",
        "desc": "Galette, fromagère, frites + tikka",
        "price": "7,50 €",
        "priceMenu": "Menu 9,00 €",
        "tag": "Épicé",
        "rating": 94,
      ...
      {
        "name": "Crusty Rice",
        "desc": "Tenders ou Tikka · curry, creamy ou spicy",
        "price": "7,00 €",
      ...
      {
        "name": "Bucket Family",
        "desc": "Boisson 1,5 L · wings · tenders · burgers · tacos",
        "price": "48,00 €",
        "tag": "XXL",
        "rating": 90,
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "name": "Big Ben's",
        "desc": "Salade, double steak, cheddar",
        "price": "5,50 €",
        "priceMenu": "Menu 7,50 €",
      ...
      {
        "name": "Tikka Burger",
        "desc": "Salade, cheddar, poulet tikka",
        "price": "5,49 €",
        "priceMenu": "Menu 7,49 €",
        "image": "https://images.unsplash.com/photo-1603064752734-4c48eff53d05?auto=format&fit=crop&w=500&q=60",
        "allergens": ["Gluten", "Oeufs", "Lait", "Sésame"]
      },
      {
        "name": "Burger Fish",
        "desc": "Salade, filet de poisson pané, cheddar",
        "price": "4,90 €",
        "priceMenu": "Menu 5,99 €",
        "image": "https://images.unsplash.com/photo-1551782450-a2132b4ba21d?auto=format&fit=crop&w=500&q=60",
        "allergens": ["Gluten", "Oeufs", "Poissons", "Lait", "Sésame"]
      },
      {
        "name": "Suprême Burger",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "price": "7,50 €",
        "priceMenu": "Menu 9,00 €",
        "image": "https://images.unsplash.com/photo-1613514785940-daed07799d9b?auto=format&fit=crop&w=500&q=60",
        "allergens": ["Gluten", "Lait"]
      },
      {
        "name": "Tacos Tenders",
      ...
      },
      {
        ...
        "price": "7,00 €",
        "priceMenu": "Menu 8,50 €",
        "image": "https://images.unsplash.com/photo-1584606436906-8c430932bbfa?auto=format&fit=crop&w=500&q=60",
        "allergens": ["Gluten", "Lait"]
      },
      {
        "name": "Wraps",
        "desc": "Mix · Steak · Tenders · Tikka",
        "price": "En resto",
  ...
  },
  {
    ...
    "items": [
      {
        "name": "Tenders",
        "desc": "2 pcs 2,00 € · 4 pcs 3,90 € · 6 pcs 5,80 €",
        "price": "Menu 7,90 €",
      ...
      },
      {
        ...
        "allergens": ["Gluten", "Oeufs", "Soja", "Mollusques"]
      },
      {
        "name": "Fish Tenders",
        "desc": "3 pcs 2,70 €",
      ...
      },
      {
        ...
        "desc": "3 pcs 2,90 €",
        "price": "6 pcs 4,90 €",
        "image": "https://images.unsplash.com/photo-1551228446-3f41635ab66a?auto=format&fit=crop&w=500&q=60",
        "allergens": ["Gluten", "Oeufs", "Mollusques"]
      },
      {
        "name": "Bouchées camembert",
        "desc": "2 pcs 1,50 € · 4 pcs 2,80 €",
        "price": "6 pcs 3,90 €",
        "image": "https://images.unsplash.com/photo-1628198622736-4d22188ab6bc?auto=format&fit=crop&w=500&q=60",
        "allergens": ["Gluten", "Lait"]
      },
      {
        "name": "Onion Rings",
        "desc": "5 pcs 1,90 € · 8 pcs 2,90 €",
        "price": "12 pcs 4,00 €",
    ...
    "items": [
      {
        ...
        "price": "6,00 €",
        "image": "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=500&q=60",
        "allergens": ["Poissons", "Sésame", "Mollusques"]
      },
      {
        "name": "Salade Tikka",
    ...
    "items": [
      {
        ...
        "price": "16,00 €",
        "image": "https://images.unsplash.com/photo-1614777986387-015c2a8c16a1?auto=format&fit=crop&w=500&q=60",
        "allergens": ["Gluten"]
      },
      {
        "name": "Bucket Quattro",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        "name": "Tarte Daim",
        "price": "2,40 €",
        "image": "https://images.unsplash.com/photo-1551024506-0bccd828d307?auto=format&fit=crop&w=500&q=60",
        "allergens": ["Gluten", "Oeufs", "Lait", "Fr.coques", "Soja"]
      },
      {
        "name": "Tiramisu Maison",
        "desc": "Chocolat / caramel",
        "price": "3,00 €",
...
new_menu_str = "export const MENU = " + json.dumps(menu, indent=2, ensure_ascii=False) + " as const;"
content = re.sub(r'export const MENU = \[.*?\] as const;', new_menu_str, content, flags=re.DOTALL)

with open('src/data/site.ts', 'w', encoding='utf-8') as f:
    f.write(content)

print("Updated site.ts with unique images and Best Sellers section")
